...
export default defineExplainer({
  ...
  steps: [
    ...
    },
    {
      ...
      camera: { position: [1.7, 0.95, -2.8], target: [0.2, 0.5, -0.35] },
    ...
    },
    {
      ...
      camera: { position: [-1.3, 1.9, -3.7], target: [0, 1.5, -0.5] },
      onEnter: view(1, false),
    ...
    },
    {
      ...
      camera: { position: [2.1, 0.8, -2.0], target: [0.38, 0.42, -0.5] },
      onEnter: view(1, false),
    ...
    },
    {
      ...
      camera: { position: [0.9, 3.2, 3.1], target: [0, 2.0, -0.3] },
      onEnter: view(1, false),
